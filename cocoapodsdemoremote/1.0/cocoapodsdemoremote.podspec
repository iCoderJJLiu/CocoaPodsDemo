# `pod spec create cocoapodsdemoremote` 建 cocoapodsdemoremote.podspec 文件。
#  Be sure to run `pod spec lint cocoapodsdemoremote.podspec' to ensure this is a
Pod::Spec.new do |s|
  s.name         = "cocoapodsdemoremote"
  s.version      = "1.0"
